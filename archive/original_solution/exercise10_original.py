...
model_checkpoint_callback = keras.callbacks.ModelCheckpoint(
    filepath='best_mdl.hdf5', # set to 'best_mdl.hdf5' if you want only the best model, overall or to '{epoch:02d}-{val_loss:.5f}.hdf5' if you want to save the best model as the training proceed (best model over time)
...
# loading best model
model = keras.models.load_model('best_mdl.hdf5')
